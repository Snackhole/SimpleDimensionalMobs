...
public class ModelFarSpider extends ModelBase {
    /**
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityFarSpider entityFarSpider = (EntityFarSpider) entitylivingbaseIn;
        ...
        this.wolfHeadMain.rotateAngleZ = entityFarSpider.getInterestedAngle(partialTickTime) + entityFarSpider.getShakeAngle(partialTickTime, 0.0F);
        this.wolfMane.rotateAngleZ = entityFarSpider.getShakeAngle(partialTickTime, -0.08F);
        this.wolfBody.rotateAngleZ = entityFarSpider.getShakeAngle(partialTickTime, -0.16F);
        this.wolfTail.rotateAngleZ = entityFarSpider.getShakeAngle(partialTickTime, -0.2F);
    }
